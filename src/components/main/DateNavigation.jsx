...
const DateNavigation = () => {
    ...
    const departuresClass = pathname.includes('departures')
        ...
        : 'departures'
    const arrivalsClass = pathname.includes('arrivals') ? 'arrivals arrivals-active' : 'arrivals'

    return (
        <section className="optional">
            <div className="navigation">
                <Link to="/departures" className={departuresClass}>
                ...
                <Link to="/arrivals" className={arrivalsClass}>
